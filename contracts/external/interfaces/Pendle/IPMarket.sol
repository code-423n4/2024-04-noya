...
import "./IPStandardizedYield.sol";
import "../../../external/libraries/Pendle/MarketMathCore.sol";
// import "./IPGauge.sol";
// import "../../../external/libraries/math/MarketMathCore.sol";
...
interface IPMarket is IERC20Metadata {
    ...
    function readTokens() external view returns (IPStandardizedYield _SY, IPPrincipalToken _PT, IPYieldToken _YT);
