...
library PendlePtOracleLib {
     ...
     */
    function getPtToAssetRate(IPMarket market, uint32 duration) internal view returns (uint256 ptToAssetRate) {
        ...
        uint256 assetToPtRate = uint256(MarketMathCore._getExchangeRateFromImpliedRate(lnImpliedRate, timeToExpiry));
